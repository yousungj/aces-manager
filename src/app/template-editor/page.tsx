...
const TEMPLATES: TemplateOption[] = [
  ...
  { id: "swc-16inch", name: "SWC 16 inch", filePath: "/data/swc-16inch-ids.json" },
  { id: "cc1", name: "Car Cover Small", filePath: "/data/cc1-ids.json" },
  { id: "cc2", name: "Car Cover Medium", filePath: "/data/cc2-ids.json" },
  { id: "cc3", name: "Car Cover Large", filePath: "/data/cc3-ids.json" },
  { id: "cc4", name: "Car Cover XL1", filePath: "/data/cc4-ids.json" },
  { id: "cc5", name: "Car Cover XL2", filePath: "/data/cc5-ids.json" },
